...
factors_selected = sum(Variance_Explained_Table_copy[,1] >= 0.7)
...
Considering the loadings and the eigenvalues, we will use 4 factors.
...
Component3 : DaysSinceEnrol
Component4 : QualMiles

These are columns 5, 3, 7, 2 respectively of the data matrix `Projectdata`. 
...
```{r echo=TRUE, eval=TRUE, tidy=TRUE}
segmentation_attributes_used = c(2,3,5,7) 
